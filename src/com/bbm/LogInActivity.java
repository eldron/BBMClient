...
//	public static final String EXTRA_EMAIL = "com.example.android.authenticatordemo.extra.EMAIL";
	...
	public void attemptLogin(){
		...
		if(cancel){
			...
			Document doc = LogInDocGen.genDoc(mUsername, mPassword);
		...
		public void handleMessage(Message msg){
			switch(msg.what){
				...
				case HandlerConstants.LOGIN_FAILED:
					showProgress(false);
					mLoginStatusMessageView.setText("µÇÂ½Ê§°Ü£¡");
					break;
...
//
//			// network access, log in the user, return true if user name and password matches,
//			// return false if the user name exists but user name and password don't match
//
//			// TODO: register the new account here.
//			// register the user first, then log in the user, return true
//			return true;
//		}
//
//		@Override
